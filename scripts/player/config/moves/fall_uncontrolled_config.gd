...
# The original's TdMove_FallingUncontrolled. [ME:CONFIRMED 11 §11.2] its CDO
# carries exactly one check -- bCheckForSoftLanding -- and ControllerState =
# PlayerDying. Every other probe is absent, which is what makes the outcome
...
## both.
##
## PROJECT-DEFINED, whole cloth -- and so is the effect it scales. The
